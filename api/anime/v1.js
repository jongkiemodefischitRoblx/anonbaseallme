...
export default async function handler(req, res) {
  ...
  async function getVideoIds() {
    try {
      ...
      return ["k0gUQYcQ5JY","R54NeEHCvh4","mC7_S2Tpbf8"];
    }
  }
...
<style>
  ...
  #closeBtn{
    position:absolute;top:20px;right:30px;color:#ff00ff;font-size:2em;font-weight:bold;cursor:pointer;
  }
</style>
</head>
<body>
